      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex flex-col items-start text-left">
          ...
          <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-background-soft border border-primary mb-8 shadow-sm group cursor-default">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-secondary group-hover:text-(--color-primary) transition-colors">
              v2.0 is now live
            </span>
          </div>

          <h1 className="text-5xl md:text-7xl font-black text-primary tracking-tighter mb-6 leading-[1.05]">
            Build your <br />
          ...
          <p className="text-lg text-secondary font-medium max-w-lg mb-10 leading-relaxed">
          ...
          <div className="flex flex-wrap gap-4 items-center">
            <button className="px-8 py-4 rounded-2xl bg-(--text-color-primary) text-background font-bold text-[11px] uppercase tracking-widest hover:bg-primary hover:text-white hover:-translate-y-1 transition-all duration-300 shadow-xl shadow-black/10 flex items-center gap-3 active:scale-95">
              Get Started Free <FaRocket />
            </button>
            <button className="px-8 py-4 rounded-2xl bg-background-soft border border-primary text-primary font-bold text-[11px] uppercase tracking-widest hover:border-(--color-primary) hover:text-(--color-primary) transition-all active:scale-95 shadow-sm">
              Live Demo
            </button>
          </div>
          ...
          <div className="mt-12 flex items-center gap-8">
            <div className="flex items-center gap-2.5 group">
              ...
              <span className="text-[10px] font-black text-muted uppercase tracking-widest group-hover:text-secondary">
                Cloud Compiler
              </span>
            </div>
            <div className="flex items-center gap-2.5 group">
        ...
        <div className="relative hidden lg:block group">
          ...
          <div className="relative z-20 bg-background-soft/40 backdrop-blur-2xl border border-secondary/50 rounded-[3rem] p-4 shadow-2xl rotate-3 group-hover:rotate-0 transition-all duration-700">
