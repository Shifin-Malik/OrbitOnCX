...
const UserManagement = () => {
  ...
  const handleToggleBlock = async (user) => {
    try {
      ...
      const statusText = user.status || (user.isBlocked ? "Blocked" : "Active");
            ...
            <tbody className="divide-y divide-[var(--border-color-primary)]">
                  ...
                  >
                    ...
                    <td className="px-7 py-4 text-center">
                      <div
                        className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[9px] font-black uppercase border ${
                          isBlocked
                            ? "text-[var(--color-danger)] bg-[var(--color-danger-glow)] border-[var(--color-danger)]"
                            : "text-[var(--color-success)] bg-[var(--color-success-glow)] border-[var(--color-success)]"
                        }`}
                      >
                        <div
                    ...
                    <td className="px-7 py-4 text-right">
                      <div className="flex justify-end gap-3">
                        ...
                        <button
                          disabled={isProcessing || statusText === "Deleted"}
                          onClick={() => handleToggleBlock(user)}
                          className={`p-2.5 rounded-xl transition-all border disabled:opacity-50 disabled:cursor-not-allowed ${
                            isBlocked
                              ? "bg-[var(--color-success-glow)] border-[var(--color-success)] text-[var(--color-success)]"
                              : "bg-[var(--color-background-elevated)] border-[var(--border-color-primary)] text-[var(--text-color-muted)] hover:text-[var(--color-danger)]"
                          }`}
                        >
                          {isProcessing ? (
                        ...
                        <button
                          ...
                          className="p-2.5 rounded-xl bg-[var(--color-background-elevated)] text-[var(--text-color-muted)] hover:bg-[var(--color-danger)] hover:text-white transition-all border border-[var(--border-color-primary)] shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          <FaTrash size={12} />
                        </button>
                      </div>
              ...
              {users.length === 0 && (
                <tr>
                  <td
                    colSpan="4"
                    className="px-7 py-10 text-center text-[12px] font-black uppercase tracking-widest text-[var(--text-color-muted)]"
                  >
                    No users found
                  </td>
                </tr>
